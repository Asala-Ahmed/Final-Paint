    ...
    public void draw(Graphics g) {
        g.setColor(getColor());
               if(getX1() < getX2() && getY1() < getY2())
                   g.drawRect(getX1(),getY1(),getX2()-getX1(),getX2()-getX1());
               else if(getX1() > getX2() && getY1()> getY2())
                   g.drawRect(getX2(),getY2(),getX1()-getX2(),getX1()-getX2());
               else if(getX1() < getX2() && getY2() < getY1())
                   g.drawRect(getX1(),getY2(),getX2()-getX1(),getX2()-getX1());
               else if(getX1() > getX2() && getY2()> getY1())
                   g.drawRect(getX2(),getY1(),getX1()-getX2(),getX1()-getX2());
    }
